return function()
	local Stlr = Instance.new("ScreenGui");
	Stlr.DisplayOrder = 1000;
	Stlr.Name = "Stlr";
	Stlr.ResetOnSpawn = false;
	Stlr.AutoLocalize = false;
	...
	Stlr.Parent = game:GetService("StarterGui");
	return Stlr;
end;
